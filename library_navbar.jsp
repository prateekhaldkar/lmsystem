...
<nav class="bg-white dark:bg-gray-900 fixed h-20 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="index.do" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="static/media/images/reading-book.png" class="h-8" alt="Flowbite Logo">
            <span class="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">${param.name}</span>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <a href="getstarted.do">    
                <button type="button" class="text-white bg-orng hover:bg-orng1 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-4 py-2 text-center">Get started</button>
            </a>
