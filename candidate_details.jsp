<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col max-w-lg mx-auto">
                    <form action="candidate_profilePic_upload.do" id="candidateProfilePic" style="background-image: linear-gradient(90deg, #1a2662f9 0%, #1f2b6af9 86%)" class="dropzone rounded-xl border-orngl border-3 border-dashed max-w-lg mx-auto">
                ...
                <form action="candidate_details.do" method="post" class="max-w-lg mx-auto">
    ...
    <script>
        ...
        const dropzone = new Dropzone('#candidateProfilePic', {
            maxFiles: 1,
            maxFilesize: 1,
