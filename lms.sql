...
insert into user_type(type) values('candidate'),('library'),('librarian'),('publisher');
...
create table membership(
    ...
    user_id int not null,
    constraint fk_membership_users foreign key (user_id) references users(user_id),
    library_id int not null,
...
create table issued_books(
    ...
    constraint issued_books_membership foreign key (membership_id) references membership(membership_id),
